...
struct TomographyConfig {
    ...
    float slice_dh = 0.3f;         // Height interval between slices // TODO: 它是如何影响的
    float ground_h = 0.0f;         // Ground height
    float interval_min = 0.0001f;     // Minimum traversable interval
    float slope_max = 0.9f;      // Maximum traversable slope (degrees) 3.1415926/12 = 0.261799388, 3.1415926/6 = 0.523598776 3.1415926/9 = 0.34906585
